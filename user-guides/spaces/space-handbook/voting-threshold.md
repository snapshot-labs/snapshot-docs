...
[Validation Strategies](../../validation-strategies.md) are a way to define who is allowed to vote on a proposal or create a new one.&#x20;

[Voting Strategies](../../voting-strategies.md) calculate how much Voting Power each user has.
...
Select the [**Basic Voting Validation**](../../validation-strategies.md#validation-strategy-example-basic)**.**
...
Select the [**Gitcoin Passport Validation**](../../validation-strategies.md#validation-strategy-example-gitcoin-passport).
