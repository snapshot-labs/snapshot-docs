...
Head to the strategy's details page and click **Playground** button. Follow the instructions from [#testing-a-voting-strategy](what-is-a-strategy.md#testing-a-voting-strategy "mention")to see if it works as you intended.
