...
* [Spaces](spaces/README.md)
  ...
  * [Create a space](spaces/create/README.md)
    * [Create an ENS domain](spaces/create/before-creating-your-space.md)
    * [Alternative way to create a space](spaces/create/alternative-way-to-create-a-space.md)
